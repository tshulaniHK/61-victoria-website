      ...
      <div class="nav-card-top">
                                                            ...
                                                            <footer class="site-footer">
                                                              <div class="footer-inner">
                                                                ...
                                                                <div class="footer-brand">61 Victoria — Social Impact ePortfolio</div>
                                                                  <div class="footer-sub">&copy; 2026 61 Victoria — LLL</div>
                                                                    </div>
        ...
        <div class="grid-2" style="margin-bottom: 3rem;">
          ...
          <article class="card">
            ...
            <div class="card-body">
             ...
             <div class="photo-grid">
                        <img src="images/IMG-20260515-WA0181.jpg" alt="Learners at SU Open Day 1" onclick="openLightbox(this.src)">
                        <img src="images/IMG-20260515-WA0161.jpg" alt="Learners at SU Open Day 2" onclick="openLightbox(this.src)">
                        <img src="images/IMG-20260515-WA0163.jpg" alt="Campus tour" onclick="openLightbox(this.src)">
                        <img src="images/IMG-20260515-WA0164.jpg" alt="Faculty visit" onclick="openLightbox(this.src)">
                        <img src="images/IMG-20260515-WA0169.jpg" alt="Group discussion" onclick="openLightbox(this.src)">
                        <img src="images/IMG-20260515-WA0170.jpg" alt="Learners exploring campus" onclick="openLightbox(this.src)">
                        <img src="images/IMG-20260515-WA0173.jpg" alt="Mentor session" onclick="openLightbox(this.src)">
                        <img src="images/IMG-20260515-WA0174.jpg" alt="Group photo at SU" onclick="openLightbox(this.src)">
                   </div>
          ...
          <article class="card">
           ...
           <div class="photo-grid">
                        <img src="images/Session-2/IMG-20260515-WA0085.jpg" alt="Learners at SU Open Day 1" onclick="openLightbox(this.src)">
                        <img src="images/Session-2/IMG-20260515-WA0103.jpg" alt="Learners at SU Open Day 2" onclick="openLightbox(this.src)">
                        <img src="images/Session-2/IMG-20260515-WA0110.jpg" alt="Campus tour" onclick="openLightbox(this.src)">
                        <img src="images/Session-2/IMG-20260515-WA0119.jpg" alt="Faculty visit" onclick="openLightbox(this.src)">
                        <img src="images/Session-2/IMG-20260515-WA0132.jpg" alt="Group discussion" onclick="openLightbox(this.src)">
                        <img src="images/Session-2/IMG-20260515-WA0142.jpg" alt="Learners exploring campus" onclick="openLightbox(this.src)">
                        <img src="images/Session-2/IMG-20260515-WA0144.jpg" alt="Mentor session" onclick="openLightbox(this.src)">
                        <img src="images/Session-2/IMG-20260515-WA0154.jpg" alt="Group photo at SU" onclick="openLightbox(this.src)">
                   </div>
...
═══════════════════════════════════════════════════════ -->
  ...
  <div class="guest-avatar">FS</div><!-- Replace with initials -->
  <div class="guest-info">
  <h4>Fatima Shabodien</h4><!-- Replace -->
  <div class="guest-role">Independent Development Consultant</div><!-- Replace -->
  <p>Fatima Shabodien is a South African feminist activist and academic whose work focuses on gender justice, social inequality, and the lasting impacts of apartheid. She began her activism during the late apartheid period and has since played an important role in advancing intersectional feminist thought in South Africa. Her work highlights how race, class, and gender intersect, particularly in shaping the experiences of Black women in the post-apartheid era.</p><!-- Replace -->
  <div class="guest-quote">
  "Move beyond perfomartive activism and engage in conversations that will promote justice and equality within our communities."
  ...
  <div class="photo-grid">
  <img src="images/Dinners/fatima1.jpg" alt="Dinner conversation" onclick="openLightbox(this.src)">
  <img src="images/Dinners/fatima2.jpg" alt="Guests at the table" onclick="openLightbox(this.src)">
...
═══════════════════════════════════════════════════════ -->
  ...
  <blockquote>
  "The Makupula Secondary School project has been a meaningful and eye-opening experience, as through both the Stellenbosch University Open Day and our visit to Makupula Secondary School, I gained a deeper understanding of how important access to information, exposure, and guidance is for learners preparing for university. At the Open Day, I saw how powerful exposure can be, as for many learners it was their first time on a university campus, which helped make higher education feel more real and attainable, and I realised how unfamiliar and intimidating these spaces can feel, and how much confidence can grow simply through guided exposure and open conversations. At Makupula, I learned the value of patience and clear communication in mentorship, as many learners are capable but lack structured support around applications, funding, and study options, and this experience showed me how important it is to create a space where learners feel supported and comfortable asking questions."
</blockquote><!-- Replace with real reflection -->
  <div class="r-author">
  <div class="avatar">SN</div><!-- Replace initials -->
  <div>
  <div class="r-name">Sikhanyiso Nkosi</div><!-- Replace -->
  ...
  <div class="reflection-card">
  <blockquote>
  "Working on the Makupula Secondary School project has been an enriching experience that highlighted for me how uneven access to guidance and information can shape learners’ educational journeys. Being part of the SU Open Day allowed me to see how powerful it is for learners to step into a university setting, as it shifts higher education from something abstract into something tangible, while also revealing how uncertain many students feel when encountering such environments for the first time. Our follow-up visit to Makupula Secondary School further reinforced this, as engaging directly with learners showed me that many have strong aspirations but often lack clarity on the practical steps needed to pursue them, particularly around applications, funding, and available programmes. Overall, the project made me more aware of how meaningful consistent engagement and accessible guidance can be in helping learners better understand their options and feel more confident about their futures after matric."
</blockquote><!-- Replace -->
  <div class="r-author">
  <div class="avatar">TK</div><!-- Replace -->
  <div>
  <div class="r-name">Tshulani Khosa</div><!-- Replace -->
  <div class="r-role">61 Victoria, 2026</div>
  </div>
  </div>
  </div>
  ...
  <div class="reflection-card">
  <blockquote>
  "Working with Makupula Secondary School and continuing the relationship established by previous LLL houses with the same SDG has shown the importance of sustainability of any project - but particularly those which contribute to the shaping of young minds and their access to fair and reliant mentorship. Our sessions thus far have shown how important it is to share resources and lived experience with the future of our country."
</blockquote><!-- Replace -->
  <div class="r-author">
  <div class="avatar">IK</div><!-- Replace -->
  <div>
  <div class="r-name">In-Aam Kafaar</div><!-- Replace -->
  <div class="r-role">61 Victoria, 2026</div>
  </div>
  </div>
  </div>
  ...
  <div class="reflection-card">
  <blockquote>
  "Reflecting on the first session during the Stellenbosch University Open Day, aside from the weather, I really enjoyed the experience, especially working with the Grade 12 learners, who were respectful and eager to engage, although both they and I were initially a bit nervous, which is understandable in a new environment. The second session, where we visited the school with my housemates, felt even more impactful, as many learners seemed more open to the idea of pursuing further education after Grade 12 and more comfortable discussing their future plans and possibilities. One of my biggest takeaways from this house project is how important exposure and access to information can be, especially since I also attended a public school with limited resources and often feel that an opportunity like this during my matric year would have helped me transition into university life more confidently by knowing what to expect. Even for those who may not choose the university route, it is important that they now know it is an available option, because sometimes opportunities feel limited simply due to lack of exposure, and learning about different paths can broaden horizons and help people imagine bigger futures. I was truly happy to be part of this project and grateful for the opportunity to contribute in a meaningful way"
</blockquote><!-- Replace -->
  <div class="r-author">
  <div class="avatar">LM</div><!-- Replace -->
  <div>
  <div class="r-name">Lerato Mashedi</div><!-- Replace -->
  <div class="r-role">61 Victoria, 2026</div>
  </div>
  </div>
  </div>
  ...
  <div class="r-author">
  <div class="avatar">WF</div><!-- Replace -->
  <div>
  <div class="r-name">Wayde Francis</div><!-- Replace -->
  <div class="r-role">61 Victoria, 2026</div>
  </div>
  </div>
  </div>
  ...
  <div class="r-author">
  <div class="avatar">OL</div><!-- Replace -->
  <div>
  <div class="r-name">Ofentse Ledwaba</div><!-- Replace -->
  <div class="r-role">61 Victoria, 2026</div>
  </div>
  </div>
  </div>
...
to match each partner's sector if you like.
        ...
        <div class="grid-2" style="margin-bottom: 3rem;">
          ...
          <div class="partner-card">
            <div class="partner-icon-row">
              ...
              <h4>Centre for the Advancement of Social Impact and Transformation (CASIT)</h4>
            </div>
            <p>The Centre is mandated to advance, advocate, engage, advise, guide, develop, support, facilitate, activate, co-create, influence, enable, coordinate institutional engagements in terms of Social Impact and Transformation at Stellenbosch University.</p>
  </div>
  ...
  <h4>The Unidreams Foundation</h4>
  </div>
  <p>Unidreams Foundation is a youth-led nonprofit organization committed to bridging the gap between ambition and access for students from underserved communities. Founded on the belief that every dream is valid and achievable, we empower young people by providing mentorship, university application support, and resources to help them unlock their full academic and personal potential.</p>
  </div>
  ...
  <div class="sec-title">Partnerships</div>
  
  <div style="display:flex;flex-wrap:wrap;gap:24px;align-items:center;padding:2rem 0;">
  <img src="images/Partners/Makupula.PNG" alt="Makupula Secondary High School" style="height:60px;width:auto;"  onclick="openLightbox(this.src)">
  <img src="images/Partners/Casit.JPG" alt="CASIT" style="height:60px;width:auto;"  onclick="openLightbox(this.src)">
   <img src="images/Partners/LLL.jpg" alt="LLL" style="height:60px;width:auto;" onclick="openLightbox(this.src)">
    <img src="images/Partners/Unidream.jpg" alt="The Unidreams Foundation" style="height:60px;width:auto;" onclick="openLightbox(this.src)">
  </div>
